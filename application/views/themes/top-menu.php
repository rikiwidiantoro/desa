            ...
            <div class="row">
                ...
                <div class="span6">
                    ...
                    <ul class="social-network">
                        ...
                        <li><a href="https://instagram.com/desaplancungan?utm_medium=copy_link" data-placement="bottom" title="Instagram"><i class="icon-instagram icon-white"></i></a>
                        </li>
                            ...
                            <ul class="nav topnav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown"><a href="<?php echo base_url('profil/desa'); ?>">Profil Desa<i class="icon-angle-right"></i></a>
